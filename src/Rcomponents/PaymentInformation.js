...
const PaymentInformation = ({paymentType, setPaymentType}) => {
    ...
    return (
        <>
            <img className="pb-4" src={PaymentOptions} alt="Payment Options" width="10%" height="auto"/>
                <form className="pb-5 mb-5">
                    <div id="preferred payment method" className="d-flex pb-5">
                        <label htmlFor="sample-setting" className='d-inline pe-2'>Payment method: </label>
                    ...
                    <>
                            <div id="form-input-credit-card-number">
